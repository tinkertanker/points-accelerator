...
5. Create shop items.
6. Test `/award points`, `/award currency`, `/award currencygroup`, `/award currencybulk`, `/deduct group`, `/deduct member`, `/deduct mixed`, `/luckydraw`, `/transfer`, `/donate`, `/store`, `/buy`, and `/sell` in the class server.
